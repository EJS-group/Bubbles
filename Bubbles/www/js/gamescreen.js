...
function showSadEmoji(x, y, duration = 1000) {
    ...
    sadEmoji.style.width = '8vw'; // Adjust the size of the gif (can be changed)
    sadEmoji.style.height = '8vw'; // Adjust the size of the gif (can be changed)
...
document.getElementById('homeButton').addEventListener('click', () => {
    ...
    setTimeout(call, 200);
    function call() {
        window.location.href = 'index.html?view=play'; // Navigate to playButton
    }
